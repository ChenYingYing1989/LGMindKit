...
+(NSString *)encryptString:(NSString *)string publicKey:(NSString *)pubKey{
    ...
    NSData *encryptData = [RSATool encryptData:data withKeyRef:keyRef];
    NSString *result = base64_encode_data(encryptData);
    return result;
}
...
+(NSString *)decryptString:(NSString *)string publicKey:(NSString *)pubKey{
    ...
    data = [RSATool decryptData:data withKeyRef:keyRef];
