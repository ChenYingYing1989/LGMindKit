...
+(NSString *)encryptString:(NSString *)string withKey:(NSString *)key{
    ...
    NSMutableString *str1 = [DESTool urlEncode:string];
    NSMutableString *encode = [NSMutableString stringWithString:[DESTool doCipher:str1 key:key context:kCCEncrypt]];
//    [DESTool formatSpecialCharacters:encode];
    return encode;
}
+(NSString *)decryptString:(NSString *)string withKey:(NSString *)key{
    NSMutableString *str1 = [NSMutableString stringWithString:string];
    [DESTool reformatSpecialCharacters:str1];
    NSString *result = [DESTool doCipher:str1 key:key context:kCCDecrypt];
    return result;
}

+(NSMutableString *)urlEncode:(NSString*)string{
    NSMutableString *encodeStr = [NSMutableString stringWithString:[string stringByAddingPercentEscapesUsingEncoding:NSUTF8StringEncoding]];
...
+ (NSString *)encodeBase64WithString:(NSString *)strData {
    return [DESTool encodeBase64WithData:[strData dataUsingEncoding:NSUTF8StringEncoding]];
}
...
+ (NSString *)doCipher:(NSString *)sTextIn key:(NSString *)sKey
    ...
    if (encryptOrDecrypt == kCCDecrypt) {
        dTextIn = [[DESTool decodeBase64WithString:sTextIn] mutableCopy];
    }
    else{
...
//    Byte iv[] = {0x12, 0x34, 0x56, 0x78, 0x90, 0xAB, 0xCD, 0xEF};
    ...
    if (encryptOrDecrypt == kCCDecrypt){
        ...
        free(bufferPtr1);
        sResult = [DESTool encodeBase64WithData:dResult];
    }
    return sResult;
}
